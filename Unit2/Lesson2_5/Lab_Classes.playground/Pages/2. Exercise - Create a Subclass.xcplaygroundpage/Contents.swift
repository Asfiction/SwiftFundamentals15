...
print("Current position: \(destroyer.position)")
destroyer.moveRight()
print("Current position: \(destroyer.position)")
...
print ("The 'falcon' instance comes directly from the 'Spaceship' class, which does not have a 'weapon' property. Only instances of the 'Fighter' subclass have access to the 'weapon' property.")
