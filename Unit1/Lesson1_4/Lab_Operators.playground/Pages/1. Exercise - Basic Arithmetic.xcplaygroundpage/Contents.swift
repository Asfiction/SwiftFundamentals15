...
print("The double allows for the use of decimal values to be displayed in division, while the integer type rounds them to the nearest whole number.")
/*:
...
print(evenRemainder)
print(oddRemainder)
print("The remainder can normally be used to tell if a number is even or odd if the number is divided by 2. Even numbers will always result in zero and odd numbers will result in 1.")
/*:
