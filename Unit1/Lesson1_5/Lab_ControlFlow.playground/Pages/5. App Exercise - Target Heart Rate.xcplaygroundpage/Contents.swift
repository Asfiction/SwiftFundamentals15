...
if isInTarget {print("You're on the right track!")}
if isBelowTarget {print("You're doing great, but try to push it a bit!")}
else {print("You're on fire! Slow it down just a bit")}
